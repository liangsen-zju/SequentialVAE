...
config.MODEL.load_iter = 0
config.MODEL.load_epoch = 0

# for motionVAE
config.MODEL.p_use_pt = 0.5
config.MODEL.dim_x = 28
config.MODEL.dim_z = 16
config.MODEL.dim_h = 64
config.MODEL.dim_c = 1
config.MODEL.n_rnn_layers = 2
...
config.LOSS.lambda_smooth_rec = 0
config.LOSS.lambda_smooth_geo = 0
